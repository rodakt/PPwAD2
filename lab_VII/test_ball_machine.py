"""Testy jednostkowe dla modułu ball_machine."""

import unittest

from ball_machine import random_ball_machine
...
class TestRandomBallMachine(unittest.TestCase):
    ...
    def test_with_replacement_probability_test(self):
        ...
        self.assertGreater(
            bag.count("red"),
            bag.count("blue"),
            "Błąd w random_ball_machine() lub zaszło zdarzenie o prawdopodobieństwie < 3e-8",
        )
        self.assertGreater(
            bag.count("blue"),
            bag.count("green"),
            "Błąd w random_ball_machine() lub zaszło zdarzenie o prawdopodobieństwie < 3e-10",
        )

    def test_exception(self):
        """Test wyjątku LookupError."""
