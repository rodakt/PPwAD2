...
from fprob import RandomBallMachine
...
class TestRandomBallMachine(unittest.TestCase):
    ...
    def test_with_replacement_exact_test(self):
        ...
        """
        machine = RandomBallMachine(return_balls=True, red=3, blue=2, green=0)
    ...
    def test_without_replacement_exact_test(self):
        ...
        """
        machine = RandomBallMachine(return_balls=False, red=3, blue=2, green=0)
    ...
    def test_with_replacement_probability_test(self):
        ...
        """
        machine = RandomBallMachine(return_balls=True, red=3, blue=2, green=1)
    ...
    def test_exception(self):
        ...
        machine = RandomBallMachine(return_balls=False, red=3, blue=2, green=1)
